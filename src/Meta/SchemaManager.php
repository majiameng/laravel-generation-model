...
use tinymeng\Laravel\Meta\MySql\Schema as MySqlSchema;
use tinymeng\Laravel\Meta\Sqlite\Schema as SqliteSchema;
use tinymeng\Laravel\Meta\Postgres\Schema as PostgresSchema;
...
class SchemaManager implements IteratorAggregate
{
    ...
    /**
     * @var \tinymeng\Laravel\Meta\Schema[]
     */
    protected $schemas = [];
