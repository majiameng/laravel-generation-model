...
use tinymeng\Laravel\Coders\Model\Relations\ReferenceFactory;

class Model
{
    /**
     * @var \tinymeng\Laravel\Meta\Blueprint
     */
    private $blueprint;
    ...
    /**
     * @var \tinymeng\Laravel\Coders\Model\Mutation[]
     */
    protected $mutations = [];
     ...
     *
     * @return $this|\tinymeng\Laravel\Coders\Model\Model
     */
    ...
    /**
     * @param \tinymeng\Laravel\Meta\Blueprint[] $references
     */
    ...
    /**
     * @return \tinymeng\Laravel\Coders\Model\Mutation[]
     */
