...
use tinymeng\Laravel\Meta\SchemaManager;
...
class Factory
{
    ...
    /**
     * @var \tinymeng\Laravel\Meta\SchemaManager
     */
    protected $schemas = [];
    ...
    /**
     * @var \tinymeng\Laravel\Support\Classify
     */
    protected $class;

    /**
     * @var \tinymeng\Laravel\Coders\Model\Config
     */
    protected $config;

    /**
     * @var \tinymeng\Laravel\Coders\Model\ModelManager
     */
    protected $models;

    /**
     * @var \tinymeng\Laravel\Coders\Model\Mutator[]
     */
    protected $mutators = [];
     ...
     * @param \tinymeng\Laravel\Support\Classify $writer
     * @param \tinymeng\Laravel\Coders\Model\Config $config
     */
    ...
    /**
     * @return \tinymeng\Laravel\Coders\Model\Mutator
     */
    ...
    /**
     * @return \tinymeng\Laravel\Coders\Model\ModelManager
     */
     ...
     * @param string $schema
     *
     * @return \tinymeng\Laravel\Meta\Schema
     */
    ...
    /**
     * @param \tinymeng\Laravel\Coders\Model\Model $model
     *
    ...
    /**
     * @param \tinymeng\Laravel\Meta\Blueprint|null $blueprint
     * @param string $key
     * @param mixed $default
     *
     * @return mixed|\tinymeng\Laravel\Coders\Model\Config
     */
